...
(function (window, document) {
    ...
    const ROUTES = {
        ...
        tasks:
            "pages/tasks/tasks.php",

        staff:
            "pages/staff/staff.php",

        "client-payments":
            "pages/client-payments/client-payments.php",

        "staff-payments":
            "pages/staff-payments/staff-payments.php",

        chat:
            "pages/chat/chat.php",

        notifications:
            "pages/notifications/notifications.php",

        "website-content":
            "pages/website-content/website-content.php",

        settings:
            "pages/settings/settings.php",

        "activity-logs":
            "pages/activity-logs/activity-logs.php"
