...
(function () {
  ...
  async function loadClient() {
    ...
    try {
       ...
       * module if it already has the full data.
       */
      ...
      if (
        ...
        if (
          existingClient &&
          (existingClient.client_name || existingClient.company_name)
        ) {
      ...
      /*
       * Always request /client-auth/me as the
       * authoritative source when available.
       *
       * This returns the complete client record.
       */
      ...
      console.log(
        "[Tenspick Client Payments] " + "Authenticated client loaded:",
        state.client,
      );
    } catch (error) {
      console.warn(
        "[Tenspick Client Payments] " + "Client information loading failed:",
        error,
      );

      /*
       * Do not fail the complete payment page
       * if the client data was already available
       * from auth state.
       */
  ...
  async function loadProjects() {
    ...
    try {
      ...
      console.log(
        "[Tenspick Client Payments] " + "Projects loaded:",
        state.projects,
      );
    } catch (error) {
      console.warn(
        "[Tenspick Client Payments] " + "Project loading failed:",
        error,
      );
  ...
  async function loadPayments(projectId) {
    ...
    try {
      ...
      /*
       * Project-specific payment endpoint.
       */
      ...
      console.log("[Tenspick Client Payments] " + "Loading:", endpoint);
      ...
      console.error(
        "[Tenspick Client Payments] " + "Payment loading failed:",
        error,
      );
